...
class websocket_request(unittest.TestCase):
    ...
    def test02_read_modbus_coil(self):
        ...
        name_list=["input_coil_0","X0","input_coil_1","X1","input_coil_2","X2","input_coil_3","X3"]
    ...
    def test03_write_modbus_coil_Robot(self):
        ...
        """
        server_index=self.server_index
        name_list=["output_coil_0","Y0","output_coil_1","Y1","output_coil_2","Y2","output_coil_3","Y3"]
        values=[0,1]
