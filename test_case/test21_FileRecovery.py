...
class websocket_request(unittest.TestCase):
    ...
    def test01_file_recovery(self):
        ...
        files=["motion_param_config.json","modbus_own_qxrobot.json","modbus_other_qxrobot.json","modbus_qxVision.json","modbus_Delta_plc.json","permission.json","IO_bind.json","bus_connect.json","modbus_4_way_relay.json","bus_extio_can_v1.json","modbus_DAQM_4302.json","modbus_8_way_relay.json"]
